...
inline constexpr auto REFLECTION_STRENGTH  = "plugin:hyprglass:reflection_strength";
inline constexpr auto CORNER_RADIUS  = "plugin:hyprglass:corner_radius";
inline constexpr auto ROUNDING_POWER  = "plugin:hyprglass:rounding_power";
inline constexpr auto REFRACT_THICKNESS  = "plugin:hyprglass:refract_thickness";
inline constexpr auto REFRACT_IOR  = "plugin:hyprglass:refract_ior";
inline constexpr auto REFRACT_SCALE  = "plugin:hyprglass:refract_scale";
...
inline constexpr auto DARK_REFLECTION_STRENGTH  = "plugin:hyprglass:dark:reflection_strength";
inline constexpr auto DARK_CORNER_RADIUS  = "plugin:hyprglass:dark:corner_radius";
inline constexpr auto DARK_ROUNDING_POWER  = "plugin:hyprglass:dark:rounding_power";
inline constexpr auto DARK_REFRACT_THICKNESS  = "plugin:hyprglass:dark:refract_thickness";
inline constexpr auto DARK_REFRACT_IOR  = "plugin:hyprglass:dark:refract_ior";
inline constexpr auto DARK_REFRACT_SCALE  = "plugin:hyprglass:dark:refract_scale";
...
inline constexpr auto LIGHT_REFLECTION_STRENGTH  = "plugin:hyprglass:light:reflection_strength";
inline constexpr auto LIGHT_CORNER_RADIUS  = "plugin:hyprglass:light:corner_radius";
inline constexpr auto LIGHT_ROUNDING_POWER  = "plugin:hyprglass:light:rounding_power";
inline constexpr auto LIGHT_REFRACT_THICKNESS  = "plugin:hyprglass:light:refract_thickness";
inline constexpr auto LIGHT_REFRACT_IOR  = "plugin:hyprglass:light:refract_ior";
inline constexpr auto LIGHT_REFRACT_SCALE  = "plugin:hyprglass:light:refract_scale";
...
struct SOverridableConfig {
    ...
    Hyprlang::FLOAT* const* reflectionStrength = nullptr;
    Hyprlang::FLOAT* const* cornerRadius = nullptr;
    Hyprlang::FLOAT* const* roundingPower = nullptr;
    Hyprlang::FLOAT* const* refractThickness = nullptr;
    Hyprlang::FLOAT* const* refractIOR = nullptr;
    Hyprlang::FLOAT* const* refractScale = nullptr;
...
struct SPresetValues {
    ...
    float   reflectionStrength = static_cast<float>(SENTINEL_FLOAT);
    float   cornerRadius = static_cast<float>(SENTINEL_FLOAT);
    float   roundingPower = static_cast<float>(SENTINEL_FLOAT);
    float   refractThickness = static_cast<float>(SENTINEL_FLOAT);
    float   refractIOR = static_cast<float>(SENTINEL_FLOAT);
    float   refractScale = static_cast<float>(SENTINEL_FLOAT);
