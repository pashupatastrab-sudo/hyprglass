...
bool CShaderManager::compileGlassShader() {
    ...
    glassUniforms.reflectionStrength  = glGetUniformLocation(program, "reflectionStrength");
    glassUniforms.roundingPower  = glGetUniformLocation(program, "roundingPower");
    glassUniforms.refractThickness  = glGetUniformLocation(program, "refractThickness");
    glassUniforms.refractIOR  = glGetUniformLocation(program, "refractIOR");
    glassUniforms.refractScale  = glGetUniformLocation(program, "refractScale");
    glassUniforms.u_time = glGetUniformLocation(program, "u_time");
    ...
    glassUniforms.shadowHasInner      = glGetUniformLocation(program, "shadowHasInner");
    glassUniforms.shadowInnerBlur     = glGetUniformLocation(program, "shadowInnerBlur");
    glassUniforms.shadowInnerSpread   = glGetUniformLocation(program, "shadowInnerSpread");
    glassUniforms.shadowInnerColor    = glGetUniformLocation(program, "shadowInnerColor");
    glassUniforms.shadowInnerOffset   = glGetUniformLocation(program, "shadowInnerOffset");

    glassUniforms.shadowHasOuter      = glGetUniformLocation(program, "shadowHasOuter");
    glassUniforms.shadowOuterBlur     = glGetUniformLocation(program, "shadowOuterBlur");
    glassUniforms.shadowOuterSpread   = glGetUniformLocation(program, "shadowOuterSpread");
    glassUniforms.shadowOuterColor    = glGetUniformLocation(program, "shadowOuterColor");
    glassUniforms.shadowOuterOffset   = glGetUniformLocation(program, "shadowOuterOffset");
    glassUniforms.shadowOuterIsTrue   = glGetUniformLocation(program, "shadowOuterIsTrue");
    glassUniforms.shadowBlurStrength = glGetUniformLocation(program, "shadowBlurStrength");

    glassUniforms.trueBoxUVOffset     = glGetUniformLocation(program, "trueBoxUVOffset");
    glassUniforms.trueBoxUVScale      = glGetUniformLocation(program, "trueBoxUVScale");
