...
namespace GlobalDefaults {
    ...
    inline constexpr float   REFLECTION_STRENGTH  = 0.3f;
    inline constexpr float   CORNER_RADIUS        = 20.0f;
    inline constexpr float   ROUNDING_POWER       = 2.0f;
    inline constexpr float   REFRACT_THICKNESS    = 35.0f;
    inline constexpr float   REFRACT_IOR          = 1.7f;
    inline constexpr float   REFRACT_SCALE        = 65.0f;
