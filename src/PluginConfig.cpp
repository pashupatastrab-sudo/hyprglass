...
void registerConfig(HANDLE handle) {
    ...
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::REFLECTION_STRENGTH, Config::FLOAT{GlobalDefaults::REFLECTION_STRENGTH});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::CORNER_RADIUS, Config::FLOAT{GlobalDefaults::CORNER_RADIUS});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::ROUNDING_POWER, Config::FLOAT{GlobalDefaults::ROUNDING_POWER});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::REFRACT_THICKNESS, Config::FLOAT{GlobalDefaults::REFRACT_THICKNESS});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::REFRACT_IOR, Config::FLOAT{GlobalDefaults::REFRACT_IOR});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::REFRACT_SCALE, Config::FLOAT{GlobalDefaults::REFRACT_SCALE});
    ...
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::DARK_REFLECTION_STRENGTH, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::DARK_CORNER_RADIUS, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::DARK_ROUNDING_POWER, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::DARK_REFRACT_THICKNESS, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::DARK_REFRACT_IOR, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::DARK_REFRACT_SCALE, Config::FLOAT{SENTINEL_FLOAT});
    ...
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::LIGHT_REFLECTION_STRENGTH, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::LIGHT_CORNER_RADIUS, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::LIGHT_ROUNDING_POWER, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::LIGHT_REFRACT_THICKNESS, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::LIGHT_REFRACT_IOR, Config::FLOAT{SENTINEL_FLOAT});
    addConfigValue<Config::Values::Float>(handle, ConfigKeys::LIGHT_REFRACT_SCALE, Config::FLOAT{SENTINEL_FLOAT});
...
static void initOverridablePointers(HANDLE handle, SOverridableConfig& layer,
                                    ...
                                    const char* refractionStrength, const char* reflectionStrength,
                                    const char* chromaticAberration,
                                    ...
                                    const char* cornerRadius,
                                    const char* roundingPower, const char* refractThickness,
                                    const char* refractIOR, const char* refractScale) {
    ...
    layer.reflectionStrength  = getStaticPtr<Hyprlang::FLOAT>(handle, reflectionStrength);
    layer.cornerRadius        = getStaticPtr<Hyprlang::FLOAT>(handle, cornerRadius);
    layer.roundingPower       = getStaticPtr<Hyprlang::FLOAT>(handle, roundingPower);
    layer.refractThickness    = getStaticPtr<Hyprlang::FLOAT>(handle, refractThickness);
    layer.refractIOR          = getStaticPtr<Hyprlang::FLOAT>(handle, refractIOR);
    layer.refractScale        = getStaticPtr<Hyprlang::FLOAT>(handle, refractScale);
...
void initConfigPointers(HANDLE handle, SPluginConfig& config) {
    ...
    initOverridablePointers(handle, config.global,
        ...
        ConfigKeys::REFRACTION_STRENGTH, ConfigKeys::REFLECTION_STRENGTH,
        ConfigKeys::CHROMATIC_ABERRATION,
        ...
        ConfigKeys::ADAPTIVE_BOOST, ConfigKeys::CORNER_RADIUS,
        ConfigKeys::ROUNDING_POWER, ConfigKeys::REFRACT_THICKNESS,
        ConfigKeys::REFRACT_IOR, ConfigKeys::REFRACT_SCALE);

    initOverridablePointers(handle, config.dark,
        ConfigKeys::DARK_BLUR_STRENGTH, ConfigKeys::DARK_BLUR_ITERATIONS,
        ConfigKeys::DARK_REFRACTION_STRENGTH, ConfigKeys::DARK_REFLECTION_STRENGTH,
        ConfigKeys::DARK_CHROMATIC_ABERRATION,
        ...
        ConfigKeys::DARK_ADAPTIVE_BOOST, ConfigKeys::DARK_CORNER_RADIUS,
        ConfigKeys::DARK_ROUNDING_POWER, ConfigKeys::DARK_REFRACT_THICKNESS,
        ConfigKeys::DARK_REFRACT_IOR, ConfigKeys::DARK_REFRACT_SCALE);

    initOverridablePointers(handle, config.light,
        ConfigKeys::LIGHT_BLUR_STRENGTH, ConfigKeys::LIGHT_BLUR_ITERATIONS,
        ConfigKeys::LIGHT_REFRACTION_STRENGTH, ConfigKeys::LIGHT_REFLECTION_STRENGTH,
        ConfigKeys::LIGHT_CHROMATIC_ABERRATION,
        ...
        ConfigKeys::LIGHT_ADAPTIVE_BOOST, ConfigKeys::LIGHT_CORNER_RADIUS,
        ConfigKeys::LIGHT_ROUNDING_POWER, ConfigKeys::LIGHT_REFRACT_THICKNESS,
        ConfigKeys::LIGHT_REFRACT_IOR, ConfigKeys::LIGHT_REFRACT_SCALE);
}
...
static bool setPresetFloatField(SPresetValues& values, std::string_view key, std::string_view valueStr) {
    ...
    if (key == "reflection_strength")  { values.reflectionStrength = parsed; return true; }
    if (key == "corner_radius")  { values.cornerRadius = parsed; return true; }
    if (key == "rounding_power")  { values.roundingPower = parsed; return true; }
    if (key == "refract_thickness")  { values.refractThickness = parsed; return true; }
    if (key == "refract_ior")  { values.refractIOR = parsed; return true; }
    if (key == "refract_scale")  { values.refractScale = parsed; return true; }
...
static void mergePresetValues(SPresetValues& target, const SPresetValues& overrides) {
    ...
    mergeFloat(target.reflectionStrength, overrides.reflectionStrength);
    mergeFloat(target.cornerRadius, overrides.cornerRadius);
    mergeFloat(target.roundingPower, overrides.roundingPower);
    mergeFloat(target.refractThickness, overrides.refractThickness);
    mergeFloat(target.refractIOR, overrides.refractIOR);
    mergeFloat(target.refractScale, overrides.refractScale);
